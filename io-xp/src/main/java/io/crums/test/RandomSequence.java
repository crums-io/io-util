...
public class RandomSequence {
   ...
   *        the starting seed
   * @param seedRate
   *        the rate at which the seed is reset. Every <code>sampleRate</code> invocations of
   ...
   * the previous invocation of <code>next()</code> is one less than this.)
   * 
   * @see #jumpTo(long)
   */
  ...
  /**
   * Jumps to the given <code>index</code>. On return, {@linkplain #index()} returns supplied argument.
