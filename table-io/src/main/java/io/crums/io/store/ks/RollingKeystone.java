 ...
 * {@linkplain #put(long, boolean) put(value, false)} (i.e. with the <code>rollingCommit</code>
 * flag set to <code>true</code>) in succession (without having had forced a interleaving
 * sync).
 * 
 * <h2>Note</h2>
 * <p>
